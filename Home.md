...
If you're using [Kali Linux](https://kali.org), Metasploit is already pre-installed. See the [Kali documentation](https://www.kali.org/docs/tools/starting-metasploit-framework-in-kali/) for how to get started using Metasploit in Kali Linux.
