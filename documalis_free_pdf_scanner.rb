...
class MetasploitModule < Msf::Exploit::Remote
  ...
  def initialize(info = {})
    super(update_info(info,
      ...
      'Description' => %q{Documalis Free PDF Scanner is prone to a security vulnerability when open PDF files.When the application is used to open a specially crafted PDF file, a buffer overflow occurs allowing arbitrary code execution.
      },
      'License'         => MSF_LICENSE,
      'Author'          =>
        [
