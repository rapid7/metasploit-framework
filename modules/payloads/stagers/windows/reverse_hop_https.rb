...
module Metasploit3
  ...
  def initialize(info = {})
    super(merge_info(info,
      'Name'          => 'Reverse Hop HTTPS Stager',
      'Description'   => %q{ Tunnel communication over an HTTPS hop point. Note that you must first upload
    ...
    register_options([
      OptString.new('HOPURL', [ true, "The full URL of the hop script", "https://example.com/hop.php" ]
      )
    ], self.class)
  end
