        ...
        group_gather << framework.threads.spawn("Module(#{refname})", false, remaining_groups.shift) do |individual_group|
          begin
            ...
            sql_param_group = { g_rid: group_rid,
                                g_distinguishedName: individual_group[0][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                                g_sAMAccountType: sat_int,
                                g_sAMAccountName: individual_group[3][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                                g_whenChanged: individual_group[4][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                                g_whenCreated: individual_group[5][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                                g_description: individual_group[6][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                                g_groupType: grouptype_int,
                                g_adminCount: individual_group[8][:value].to_i,
                                g_comment: individual_group[9][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                                g_managedBy: individual_group[10][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
            ...
            users_in_group[:results].each do |group_user|
              ...
              sql_param_user = { u_rid: user_rid,
                                 u_distinguishedName: group_user[0][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                                 u_sAMAccountType: group_user[2][:value].to_i,
                                 u_sAMAccountName: group_user[3][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                                 u_displayName: group_user[4][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                                 u_description: group_user[5][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                                 u_logonCount: group_user[6][:value].to_i,
                                 u_userAccountControl: uac_int,
                                 u_userPrincipalName: group_user[8][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                                 u_whenChanged: group_user[9][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                                 u_whenCreated: group_user[10][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                                 u_primaryGroupID: group_user[11][:value].to_i,
                                 u_badPwdCount: group_user[12][:value].to_i,
                                 u_comment: group_user[13][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                                 u_title: group_user[14][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                                 u_cn: group_user[15][:value].to_s.encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                                 ...
                                 u_manager: group_user[17][:value].to_s.encode('UTF-8',:invalid=>:replace,:replace=>"?"),
    ...
    begin
      ...
      computers[:results].each do |comp|
        ...
        sql_param_computer = { c_rid: computer_rid,
                               c_distinguishedName: comp[0][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                               c_cn: comp[2][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                               c_dNSHostName: comp[3][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                               c_sAMAccountType: sat_int,
                               c_sAMAccountName: comp[5][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                               c_displayName: comp[6][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                               c_logonCount: comp[7][:value].to_i,
                               c_userAccountControl: uac_int,
                               c_whenChanged: comp[9][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                               c_whenCreated: comp[10][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                               c_primaryGroupID: comp[11][:value].to_i,
                               c_badPwdCount: comp[12][:value].to_i,
                               c_operatingSystem: comp[13][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                               c_operatingSystemServicePack: comp[14][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                               c_operatingSystemVersion: comp[15][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                               c_description: comp[16][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                               c_comment: comp[17][:value].encode('UTF-8',:invalid=>:replace,:replace=>"?"),
                               # The login script is executed
