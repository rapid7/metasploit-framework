...
class MetasploitModule < Msf::Post
  ...
  def initialize(info={})
    super(update_info(info,
      ...
      'Description'          => %q{
	This module will attempt to use MOF to establish persistence on a machine as an alternative to the persistence meterpreter script. This will require at least local administrative rights and powershell present on the machine.
      },
      'License'              => MSF_LICENSE,
      'Platform'             => ['win'],
