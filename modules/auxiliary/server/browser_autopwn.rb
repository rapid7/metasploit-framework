  ...
  def initialize(info = {})
    super(
      update_info(
        ...
        'PassiveActions' => [ 'WebServer', 'DefangedDetection' ],
        'DefaultOptions' => {
