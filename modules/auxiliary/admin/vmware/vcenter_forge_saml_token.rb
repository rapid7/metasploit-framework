    ...
    super(
      update_info(
        ...
        'Description' => %q{
          ...
          the vCenter SSO domain name and vCenter FQDN. Sane defaults
          are provided. Succesful execution returns a session cookie
          for the /ui path that grants access to the SSO domain as a
          vSphere administrator. The IdP trusted certificate chain
          can be retrieved using Metasploit post-exploitation modules
          or extracted manually from /storage/db/vmware-vmdir/data.mdb
          using binwalk.
        },
