...
class MetasploitModule < Msf::Auxiliary
  ...
  def on_request_uri(cli, request)
    ...
    if (request.uri =~ /#{@tag}$/)
      ...
      var_title = Rex::Text.rand_text_alpha(6..37)
      var_body = Rex::Text.rand_text_alpha(64..95)
      var_font = Rex::Text.rand_text_alpha(2..7)
      var_face = Rex::Text.rand_text_alpha(2..33)
