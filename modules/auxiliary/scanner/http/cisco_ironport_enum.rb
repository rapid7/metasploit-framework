...
class MetasploitModule < Msf::Auxiliary
  ...
  def run_host(ip)
    ...
    unless is_app_ironport?
      print_error("Application does not appear to be Cisco Ironport. Module will not continue.")
      return
    end
