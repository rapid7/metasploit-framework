  ...
  def initialize
    ...
    register_options(
      [
        ...
        OptString.new('EMBY_SERVER', [true, 'Emby Web UI IP to use (e.g. 10.10.10.18))', '']),
...
#        'method' => 'GET',
#        'uri' =>  datastore['EMBY_SERVER'] + ":" + datastore['EMBY_PORT'].to_s + "/Items/RemoteSearch/Image?",
#        'vars_get' => {
#          'ProviderName' => 'TheMovieDB',
#          'ImageURL' => "#{target_host}:#{p}"
#        }
#      })
