  ...
  def initialize(info = {})
    super(update_info(info,
      ...
      'Description' => %q{
        ...
        queries, but there are limitations when used with a free API key.
        The facets use the same parameters than filters, comma separated. Please
    ...
    register_options(
      [
        ...
        OptString.new('FACETS', [false, 'List of facets to get statistics for']),
