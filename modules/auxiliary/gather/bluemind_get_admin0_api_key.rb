...
class MetasploitModule < Msf::Auxiliary
  ...
  def bluemind_login
    ...
    fail_with(Failure::BadConfig, 'Authentication failed') unless resp.code == 302
  ...
  def run
    fail_with(Failure::NotVulnerable, 'Not exploitable') unless check == Exploit::CheckCode::Vulnerable
