...
public class NotYetImplementedCommand implements Command {
	...
	private NotYetImplementedCommand() {
		...
		typeNames.put(new Integer(TLVType.TLV_TYPE_SUBNET6), "TLV_TYPE_SUBNET6");
		typeNames.put(new Integer(TLVType.TLV_TYPE_NETMASK6), "TLV_TYPE_NETMASK6");
		typeNames.put(new Integer(TLVType.TLV_TYPE_GATEWAY6), "TLV_TYPE_GATEWAY6");
		typeNames.put(new Integer(TLVType.TLV_TYPE_NETWORK_ROUTE6), "TLV_TYPE_NETWORK_ROUTE6");
		...
		typeNames.put(new Integer(TLVType.TLV_TYPE_IP6), "TLV_TYPE_IP6");
