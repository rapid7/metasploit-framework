...
Sinatra::Backend::Server.post_info(mod)
Sinatra::Backend::Server.exten
Sinatra::Backend::Server.framework =@framework
Sinatra::Backend::Server::framework_post =@framework.post.keys
Sinatra::Backend::Server.run_post_script(script)
Sinatra::Backend::Server.run_exten_cmd
