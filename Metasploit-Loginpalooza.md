...
- [x] [auxiliary/scanner/http/hp_sys_mgmt_login.rb](https://github.com/rapid7/metasploit-framework/tree/master/modules/auxiliary/scanner/http/hp_sys_mgmt_login.rb)
