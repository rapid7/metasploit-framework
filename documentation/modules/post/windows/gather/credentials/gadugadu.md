...
This post-exploitation module gathers artifacts found on gadugadu related folders from end users systems.
...
3. use post/windows/gather/credentials/gadugadu
4. Set SESSION 1
