...
This post-exploitation module gathers artifacts found on windowslivemail related folders from end users systems.
...
3. use post/windows/gather/credentials/windowslivemail
4. Set SESSION 1
