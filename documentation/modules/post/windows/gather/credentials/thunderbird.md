...
This post-exploitation module gathers artifacts found on thunderbird related folders from end users systems.
...
3. use post/windows/gather/credentials/thunderbird
4. Set SESSION 1
