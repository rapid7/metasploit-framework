...
msf post(windows/gather/wmic_command) > set session 1
session => 1
msf post(windows/gather/wmic_command) > set command os
command => os
...
msf post(windows/gather/wmic_command) > cat /root/.msf4/loot/20220922071306_default_192.168.200.218_host.command.wmi_789917.txt
...
msf post(windows/gather/wmic_command) > 
```
