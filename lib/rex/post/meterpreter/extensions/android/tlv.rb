...
TLV_TYPE_VIBER_USER       = TLV_META_TYPE_STRING  | (TLV_EXTENSIONS + 9030);
TLV_TYPE_VIBER_NUMBER     = TLV_META_TYPE_STRING  | (TLV_EXTENSIONS + 9031);
TLV_TYPE_VIBER_PROFILE    = TLV_META_TYPE_RAW     | (TLV_EXTENSIONS + 9032);
TLV_TYPE_VIBER_IMAGE      = TLV_META_TYPE_RAW     | (TLV_EXTENSIONS + 9033);
TLV_TYPE_VIBER_MEDIA_ARCH = TLV_META_TYPE_RAW     | (TLV_EXTENSIONS + 9034);
TLV_TYPE_VIBER_STRING     = TLV_META_TYPE_STRING  | (TLV_EXTENSIONS + 9035);
