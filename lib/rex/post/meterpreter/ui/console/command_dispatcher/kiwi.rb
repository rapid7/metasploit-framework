      ...
      module Ui
        ...
        class Console::CommandDispatcher::Kiwi
          ...
          def cmd_password_change(*args)
            ...
            @@password_change_usage_opts.parse(args) do |opt, _idx, val|
              case opt
              when '-u'
                opts[:user] = val
              when '-s'
          ...
          #
          def cmd_lsa_dump_secrets(*_args)
          ...
          #
          def cmd_wifi_list_shared(*_args)
          ...
          def cmd_creds_all(*args)
            method = proc { client.kiwi.creds_all }
          ...
          def cmd_creds_wdigest(*args)
            method = proc { client.kiwi.creds_wdigest }
          ...
          def cmd_creds_msv(*args)
            method = proc { client.kiwi.creds_msv }
          ...
          def cmd_creds_ssp(*args)
            method = proc { client.kiwi.creds_ssp }
          ...
          def cmd_creds_livessp(*args)
            method = proc { client.kiwi.creds_livessp }
          ...
          def cmd_creds_tspkg(*args)
            method = proc { client.kiwi.creds_tspkg }
          ...
          def cmd_creds_kerberos(*args)
            method = proc { client.kiwi.creds_kerberos }
          ...
          def scrape_passwords(provider, method, args)
            ...
            accounts.each_key do |k|
              next if accounts[k].empty?
