...
module Metasploit::Framework::Module::Ancestor::Namespace
  # Returns the Metasploit(4|3|2|1) class from the module_evalled content.
  #
  # @note The module content must be module_evalled into this namespace module before the return of
  #   {#metasploit_class} is valid.
  #
  # @return [Msf::Module] if a Metasploit(4|3|2|1) class exists in this module
  ...
  def version_compatible!(module_path, module_reference_name)
    if const_defined?(:RequiredVersions)
      ...
      if (minimum_core_version > ::Msf::Framework::VersionCore or
        ...
        raise Metasploit::Framework::Module::Ancestor::Error::VersionIncompatibility.new(
                  :module_path => module_path,
                  :module_reference_name => module_reference_name,
