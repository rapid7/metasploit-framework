  ...
  class Post
    module Windows
      module Accounts
        ...
        ##
        # add_user(username, password = nil, localgroup=administrators, dont_expire_pwd = false, server_name = nil)
        #
        # Summary:
        ...
        #   localgroup        - The local group to which the specified users or global groups will be added
