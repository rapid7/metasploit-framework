    ...
    class RPC_Db < RPC_Base
      ...
      def rpc_creds(xopts)
        ::ActiveRecord::Base.connection_pool.with_connection do
          ...
          pagination_total = Metasploit::Credential::Core.where(workspace_id: wspace).count
          ...
          query.each do |cred|
            ...
            ret[:creds] << {
              user: cred.public.try(:username).to_s,
              pass: pass,
            ...
            ret[:pagination_total] = pagination_total
          end
          ret
        end
      end
      ...
      def rpc_hosts(xopts)
        ::ActiveRecord::Base.connection_pool.with_connection do
          ...
          pagination_total = wspace.hosts.where(conditions).count
      ...
      def rpc_services(xopts)
        ::ActiveRecord::Base.connection_pool.with_connection do
          ...
          pagination_total = wspace.services.includes(:host).where(conditions).count
      ...
      def rpc_vulns(xopts)
        ::ActiveRecord::Base.connection_pool.with_connection do
          ...
          pagination_total = wspace.vulns.includes(:service).where(conditions).count
      ...
      def rpc_notes(xopts)
        ::ActiveRecord::Base.connection_pool.with_connection do
          ...
          pagination_total = wspace.notes.includes(:host, :service).where(conditions).count
      ...
      def rpc_events(xopts)
        ::ActiveRecord::Base.connection_pool.with_connection do
          ...
          pagination_total = wspace.events.count
      ...
      def rpc_loots(xopts)
        ::ActiveRecord::Base.connection_pool.with_connection do
          ...
          pagination_total = wspace.loots.count
      ...
      def rpc_clients(xopts)
        ::ActiveRecord::Base.connection_pool.with_connection do
          ...
          pagination_total = wspace.clients.includes(:host).where(conditions).count
