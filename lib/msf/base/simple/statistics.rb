...
module Msf
  module Simple
    ...
    class Statistics
      ...
      #
      # Returns the number of evasion modules in the framework.
      #
      def num_evasion
      ...
      #
      # Returns the number of persistence modules in the framework.
      #
      def num_persistence
        Msf::Modules::Metadata::Cache.instance.module_counts[:persistence]
      end
    end
  end
end
