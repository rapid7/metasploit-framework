# -*- coding:binary -*-
shared_examples_for 'Metasploit::Framework::Module::Ancestor::Error::VersionIncompatibility' do
	let(:error) do
		begin
			subject.version_compatible!(module_path, module_reference_name)
		rescue Metasploit::Framework::Module::Ancestor::Error::VersionIncompatibility => error
		end
	...
	it 'should be raised' do
		expect {
			subject.version_compatible!(module_path, module_reference_name)
		}.to raise_error(Metasploit::Framework::Module::Ancestor::Error::VersionIncompatibility)
	end
