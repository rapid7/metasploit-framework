...
RSpec.describe Metasploit::Framework::Hashes do
  ...
  describe 'identify_krb5tgs-rc4' do
    it 'returns krb5tgs-rc4' do
      ...
      expect(hash).to match('krb5tgs-rc4')
    end
  end
  ...
  describe 'identify_krb5asrep-rc4' do
    it 'returns krb5asrep-rc4' do
      ...
      expect(hash).to match('krb5asrep-rc4')
    end
  end
