...
RSpec.describe Msf::Post::Azure do
  ...
  context '.process_context_contents' do
    ...
    it 'should return parsed content for azure_context file' do
      expect(subject.send(:process_context_contents, azure_context)).to eql([['example@example.onmicrosoft.com', 'User', nil, nil, nil, nil]])
    end
    ...
    it 'should return parsed content for azure_rm_context file' do
      expect(subject.send(:process_context_contents, azure_rm_context)).to eql([
        ['user1@example.onmicrosoft.com', 'User', nil, nil, nil, nil],
        ['aaaaaaaa-1111-1111-aaaa-111111111111', 'ServicePrincipal', nil, nil, nil, nil],
        [
        ...
        ['test@example.onmicrosoft.com', 'User', nil, nil, nil, nil],
        ['user2@example.onmicrosoft.com', 'User', nil, nil, nil, nil],
        [
