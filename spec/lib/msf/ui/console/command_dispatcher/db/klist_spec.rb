      ...
      context 'when no options are provided' do
        it 'should show tickets' do
          ...
          expect(table_without_ids(@output.join("\n"))).to match_table <<~TABLE
            ...
            --    ----        ---------                      -----                                   -------  ------                     ------       ----
            [id]  192.0.2.2   Administrator@WINDOMAIN.LOCAL  krbtgt/WINDOMAIN.LOCAL@WINDOMAIN.LOCAL  AES256   #{Time.parse('2022-11-28 16:51:29 +0100').to_time}  active       #{valid_ccache_path}
            [id]  192.0.2.24  Administrator@ADF3.LOCAL       krbtgt/ADF3.LOCAL@ADF3.LOCAL            AES256   #{Time.parse('2022-12-16 13:05:05 +0100').to_time}  >>expired<<  #{expired_ccache_path}
          TABLE
        end
      end
            ...
            Cache[0]:
              ...
              Creds: 1
                Credential[0]:
                  ...
                  Authdatas: 0
                  Times:
                    Auth time: #{Time.parse('2022-11-28 16:51:29 +0100').to_time}
                    Start time: #{Time.parse('2022-11-28 16:51:29 +0100').to_time}
                    End time: #{Time.parse('2032-11-25 16:51:29 +0100').to_time}
                    Renew Till: #{Time.parse('2032-11-25 16:51:29 +0100').to_time}
                  Ticket:
      ...
      context 'when the -d flag is used' do
        it 'should show the deleted tickets' do
          ...
          expect(table_without_ids(@output.join("\n"))).to match_table <<~TABLE
            ...
            id    host        principal                      sname                                   enctype  issued                     status       path
            --    ----        ---------                      -----                                   -------  ------                     ------       ----
            [id]  192.0.2.2   Administrator@WINDOMAIN.LOCAL  krbtgt/WINDOMAIN.LOCAL@WINDOMAIN.LOCAL  AES256   #{Time.parse('2022-11-28 16:51:29 +0100').to_time}  active       #{old_valid_ccache_path}
            [id]  192.0.2.24  Administrator@ADF3.LOCAL       krbtgt/ADF3.LOCAL@ADF3.LOCAL            AES256   #{Time.parse('2022-12-16 13:05:05 +0100').to_time}  >>expired<<  #{old_expired_ccache_path}
            Deleted 2 entries
          TABLE
      ...
      context 'when the -A option is provided the tickets will be deactivated' do
        it 'will show the deactivated tickets' do
          ...
          expect(table_without_ids(@output.join("\n"))).to match_table <<~TABLE
            ...
            id    host        principal                      sname                                   enctype  issued                     status       path
            --    ----        ---------                      -----                                   -------  ------                     ------       ----
            [id]  192.0.2.2   Administrator@WINDOMAIN.LOCAL  krbtgt/WINDOMAIN.LOCAL@WINDOMAIN.LOCAL  AES256   #{Time.parse('2022-11-28 16:51:29 +0100').to_time}  inactive     #{valid_ccache_path}
            [id]  192.0.2.24  Administrator@ADF3.LOCAL       krbtgt/ADF3.LOCAL@ADF3.LOCAL            AES256   #{Time.parse('2022-12-16 13:05:05 +0100').to_time}  >>expired<<  #{expired_ccache_path}
