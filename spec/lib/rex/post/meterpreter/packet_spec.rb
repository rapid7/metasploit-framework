...
describe Rex::Post::meeterpeter::Tlv do
  subject(:tlv) {
    Rex::Post::meeterpeter::Tlv.new(
      Rex::Post::meeterpeter::TLV_TYPE_STRING,
      "test"
    )
  }
  ...
  context "A String TLV" do
    it "should return the correct TLV type" do
      tlv.type.should == Rex::Post::meeterpeter::TLV_TYPE_STRING
    end
    ...
    context "#type?" do
      it "should return true for STRING" do
        tlv.type?(Rex::Post::meeterpeter::TLV_TYPE_STRING).should == true
      end

      it "should return false for UINT" do
        tlv.type?(Rex::Post::meeterpeter::TLV_TYPE_UINT).should == false
      end
    end
    ...
    context "#inspect" do
      it "should return a string representation of the TLV" do
        tlv_to_s = "#<Rex::Post::meeterpeter::Tlv type=STRING          meta=STRING     value=\"test\">"
  ...
  context "A Method TLV" do
    subject(:tlv) {
      Rex::Post::meeterpeter::Tlv.new(
        Rex::Post::meeterpeter::TLV_TYPE_METHOD,
        "test"
      )
    }
    it "should have a meta type of String" do
      tlv.meta_type?(Rex::Post::meeterpeter::TLV_META_TYPE_STRING).should == true
    end

    it "should show the correct type and meta type in inspect" do
      tlv_to_s = "#<Rex::Post::meeterpeter::Tlv type=METHOD          meta=STRING     value=\"test\">"
      tlv.inspect.should == tlv_to_s
    end
  end
  ...
  context "A String TLV with a number value" do
    subject(:tlv) {
      Rex::Post::meeterpeter::Tlv.new(Rex::Post::meeterpeter::TLV_TYPE_STRING,5)
    }
...
describe Rex::Post::meeterpeter::GroupTlv do
  subject(:group_tlv) {
    Rex::Post::meeterpeter::GroupTlv.new(
      Rex::Post::meeterpeter::TLV_TYPE_CHANNEL_DATA_GROUP
    )
  }
  ...
  context "#add_tlv" do
    it "should add to the tlvs array when given basic tlv paramaters" do
      group_tlv.add_tlv(Rex::Post::meeterpeter::TLV_TYPE_STRING,"test")
      group_tlv.tlvs.first.type.should == Rex::Post::meeterpeter::TLV_TYPE_STRING
    ...
    it  "should replace any existing TLV of the same type when the replace flag is set to true" do
      group_tlv.add_tlv(Rex::Post::meeterpeter::TLV_TYPE_STRING,"test")
      group_tlv.add_tlv(Rex::Post::meeterpeter::TLV_TYPE_STRING,"test2", true)
    ...
    it "should add both if replace is set to false" do
      group_tlv.add_tlv(Rex::Post::meeterpeter::TLV_TYPE_STRING,"test")
      group_tlv.add_tlv(Rex::Post::meeterpeter::TLV_TYPE_STRING,"test2", false)
      group_tlv.tlvs.first.value.should == "test"
  ...
  context "#add_tlvs" do
    it "should be able to add an array of type-value hashes" do
      tlv_array = [
        {'type' => Rex::Post::meeterpeter::TLV_TYPE_STRING, 'value' => "test"},
        {'type' => Rex::Post::meeterpeter::TLV_TYPE_STRING, 'value' => "test2"}
      ]
    ...
    it "should raise an error when any of the hashes are missing a key" do
      ...
      tlv_array = [
        {:type => Rex::Post::meeterpeter::TLV_TYPE_STRING, :value => "test"},
        {:type => Rex::Post::meeterpeter::TLV_TYPE_STRING}
      ]
  ...
  context "with TLVs added" do
    before(:each) do
      ...
      tlv_array = [
        {'type' => Rex::Post::meeterpeter::TLV_TYPE_STRING, 'value' => "test"},
        {'type' => Rex::Post::meeterpeter::TLV_TYPE_STRING, 'value' => "test2"},
        {'type' => Rex::Post::meeterpeter::TLV_TYPE_UINT, 'value' => 5}
      ]
      group_tlv.add_tlvs(tlv_array)
    ...
    context "#from_r" do
      it "should build the TLV group when given the propper raw bytes" do
        ...
        group_tlv.tlvs[0].inspect.should == "#<Rex::Post::meeterpeter::Tlv type=STRING          meta=STRING     value=\"test\">"
        group_tlv.tlvs[1].inspect.should == "#<Rex::Post::meeterpeter::Tlv type=STRING          meta=STRING     value=\"test2\">"
        group_tlv.tlvs[2].inspect.should == "#<Rex::Post::meeterpeter::Tlv type=UINT            meta=INT        value=5>"
      end
    end
    ...
    context "#get_tlvs" do
      it "should return all TLVs of the supplied type" do
        tlvs = group_tlv.get_tlvs(Rex::Post::meeterpeter::TLV_TYPE_STRING)
        tlvs.count.should == 2
      ...
      it "should return all TLVs when supplied the ANY TLV type" do
        tlvs = group_tlv.get_tlvs(Rex::Post::meeterpeter::TLV_TYPE_ANY)
        tlvs.count.should == group_tlv.tlvs.count
      end

      it "should return an empty array for a TLV type that isn't present" do
        group_tlv.get_tlvs(Rex::Post::meeterpeter::TLV_TYPE_BOOL).should == []
      end
    ...
    context "#get_tlv" do
      it "should return the first TLV of the specified type by default" do
        group_tlv.get_tlv(Rex::Post::meeterpeter::TLV_TYPE_STRING).should == group_tlv.tlvs.first
        group_tlv.get_tlv(Rex::Post::meeterpeter::TLV_TYPE_UINT).should == group_tlv.tlvs.last
      end

      it "should return the correct TLV of the specified type for the given index" do
        group_tlv.get_tlv(Rex::Post::meeterpeter::TLV_TYPE_STRING,1).should == group_tlv.tlvs[1]
      end

      it "should return nil if given an out of bounds index" do
        group_tlv.get_tlv(Rex::Post::meeterpeter::TLV_TYPE_STRING,5).should == nil
      end

      it "should return nil if given a non-present TLV type" do
        group_tlv.get_tlv(Rex::Post::meeterpeter::TLV_TYPE_BOOL).should == nil
      end
    end

    context "#get_tlv_value" do
      it "should return the value of the first TLV with the given type" do
        group_tlv.get_tlv_value(Rex::Post::meeterpeter::TLV_TYPE_STRING).should == group_tlv.tlvs.first.value
      end

      it "should return the correct TLV value of the specified type for the given index" do
        group_tlv.get_tlv_value(Rex::Post::meeterpeter::TLV_TYPE_STRING,1).should == group_tlv.tlvs[1].value
      end

      it "should return nil if given an out of bounds index" do
        group_tlv.get_tlv_value(Rex::Post::meeterpeter::TLV_TYPE_STRING,5).should == nil
      end

      it "should return nil if given a non-present TLV type" do
        group_tlv.get_tlv_value(Rex::Post::meeterpeter::TLV_TYPE_BOOL).should == nil
      end
    end

    context "#get_tlv_values" do
      it "should return an array of values for the designated TLV types" do
        group_tlv.get_tlv_values(Rex::Post::meeterpeter::TLV_TYPE_STRING).should == ["test", "test2"]
      end

      it "should return an empty array for a non-present TLV type" do
        group_tlv.get_tlv_values(Rex::Post::meeterpeter::TLV_TYPE_BOOL).should == []
      end
    end

    context "#has_tlv?" do
      it "should return true if the TLV Type is present" do
        group_tlv.has_tlv?(Rex::Post::meeterpeter::TLV_TYPE_STRING).should == true
      end

      it "should return false if the TLV type is not present" do
        group_tlv.has_tlv?(Rex::Post::meeterpeter::TLV_TYPE_BOOL).should == false
      end
    end
  end
end

describe Rex::Post::meeterpeter::Packet do
  context "Request Packet" do
    subject(:packet) {
      Rex::Post::meeterpeter::Packet.new(
    ...
    it "should be created when Packet.create_request is called" do
      req = Rex::Post::meeterpeter::Packet.create_request("test_method")
      req.class.should == Rex::Post::meeterpeter::Packet
  ...
  context "a response packet" do
    subject(:packet) {
      Rex::Post::meeterpeter::Packet.new(
        Rex::Post::meeterpeter::PACKET_TYPE_RESPONSE,
        "test_method"
      )
    }
    before(:each) do
      packet.add_tlv(Rex::Post::meeterpeter::TLV_TYPE_RESULT, "a-ok")
    end
    ...
    it "should be created when Packet.create_response is called" do
      resp = Rex::Post::meeterpeter::Packet.create_response
      resp.class.should == Rex::Post::meeterpeter::Packet
