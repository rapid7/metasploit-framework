...
RSpec.describe Rex::Proto::MsAdts::KeyCredential do
  ...
  it 'parses the expected value' do
    ...
    expect(credential.key_approximate_last_logon_time_stamp).to eq('2024-03-27 09:43:05 +1100'.to_datetime)
    ...
    expect(credential.device_id).to eq(["95c280f0bc6f290e4c8b6ad1d1b3545c"].pack('H*'))
