    ...
    expected_output << <<~EOF.chomp
      ...
      Creds: 1
        Credential[0]:
          ...
          Authdatas: 0
          Times:
            Auth time: #{Time.parse('2023-01-13 15:31:25 +0100').to_time}
            Start time: #{Time.parse('2023-01-13 15:31:25 +0100').to_time}
            End time: #{Time.parse('2033-01-10 15:31:25 +0100').to_time}
            Renew Till: #{Time.parse('2033-01-10 15:31:25 +0100').to_time}
          Ticket:
            ...
            Encrypted Ticket Part:
              ...
              Decrypted (with key: 4b912be0366a6f37f4a7d571bee18b1173d93195ef76f8d1e3e81ef6172ab326):
                ...
                PAC:
                  Validation Info:
                    Logon Time: #{Time.parse('2023-01-13 15:31:25 +0100').to_time}
                  ...
                  Client Info:
                    Name: 'Administrator'
                    Client ID: #{Time.parse('2023-01-13 15:31:25 +0100').to_time}
                  Pac Server Checksum:
    ...
    expected_output << <<~EOF.chomp
      ...
      Creds: 1
        Credential[0]:
          ...
          Authdatas: 0
          Times:
            Auth time: #{Time.parse('2023-01-13 15:36:39 +0100').to_time}
            Start time: #{Time.parse('2023-01-13 15:36:39 +0100').to_time}
            End time: #{Time.parse('2033-01-10 15:36:39 +0100').to_time}
            Renew Till: #{Time.parse('2033-01-10 15:36:39 +0100').to_time}
          Ticket:
            Ticket Version Number: 5
            Realm: WINDOMAIN.LOCAL
            Server Name: cifs/dc.windomain.local
            Encrypted Ticket Part:
              ...
              Decrypted (with key: 88e4d9fabaecf3dec18dd80905521b29):
                ...
                PAC:
                  Validation Info:
                    Logon Time: #{Time.parse('2023-01-13 15:36:39 +0100').to_time}
                    Logoff Time: Never Expires (inf)
                    Kick Off Time: Never Expires (inf)
                    Password Last Set: No Time Set (0)
                    Password Can Change: No Time Set (0)
                  ...
                  Client Info:
                    Name: 'Administrator'
                    Client ID: #{Time.parse('2023-01-13 15:36:39 +0100').to_time}
                  Pac Server Checksum:
