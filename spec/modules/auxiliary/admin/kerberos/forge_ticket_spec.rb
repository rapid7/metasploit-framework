        ...
        expect(@output.join("\n")).to match_table <<~TABLE
          ...
          Creds: 1
            Credential[0]:
              ...
              Authdatas: 0
              Times:
                Auth time: #{Time.parse('2022-07-15 14:33:40 +0200').to_time}
                Start time: #{Time.parse('2022-07-15 14:33:40 +0200').to_time}
                End time: #{Time.parse('2032-07-12 14:33:40 +0200').to_time}
                Renew Till: #{Time.parse('2032-07-12 14:33:40 +0200').to_time}
              Ticket:
                ...
                Encrypted Ticket Part:
                  ...
                  Decrypted (with key: 767400b2c71afa35a5dca216f2389cd9):
                    ...
                    PAC:
                      Validation Info:
                        Logon Time: #{Time.parse('2022-07-15 14:33:40 +0200').to_time}
                      ...
                      Client Info:
                        Name: 'Administrator'
                        Client ID: #{Time.parse('2022-07-15 14:33:40 +0200').to_time}
                      Pac Requestor:
