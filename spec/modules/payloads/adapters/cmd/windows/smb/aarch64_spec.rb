...
RSpec.describe 'cmd/windows/smb/aarch64' do
  include_context 'Msf::Simple::Framework#modules loading'

  # Windows AArch64 has no Meterpreter yet, so we use
  # windows/aarch64/shell_reverse_tcp as the adapted single.
  let(:subject) do
    load_and_create_module(
      module_type: 'payload',
      reference_name: 'cmd/windows/smb/aarch64/shell_reverse_tcp',
      ancestor_reference_names: [
        'adapters/cmd/windows/smb/aarch64',
  ...
  describe 'module metadata' do
    ...
    it 'adapts AArch64 and not x64 or x86 payloads' do
